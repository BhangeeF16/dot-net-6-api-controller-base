...
{
    public class AppsSettingService : IAppSettingService
    {
        ...
        public AppsSettingService(IUnitOfWork unitOfWork, IMapper mapper, ICurrentUserService currentUserService)
        {
